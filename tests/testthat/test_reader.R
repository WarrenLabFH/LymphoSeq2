...
test_that("Reads a single AIRR file correctly", {
  stable <- LymphoSeq2::readImmunoSeq(path = "test_data/015V12001549_CFAR.tsv",
                                      threads = 1)
...
test_that("Reads a list of AIRR file correctly", {
  stable <- LymphoSeq2::readImmunoSeq(path = c("test_data/015V12001549_CFAR.tsv", "test_data/015V12001685_CFAR_R.tsv"),
                                      threads = 1)
  srow <- base::nrow(stable)
